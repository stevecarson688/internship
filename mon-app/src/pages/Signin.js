          ...
          successMsg ? (
            ...
            <form className="w-[350px] mx-auto flex flex-col items-center ">
              ...
              rounded-sm outline-none focus-within:border-[#1d34e2] focus-within:shadow-amazonInput duration-100' type='password' />
                  ...
                  <button onClick={handleLogin} className='w-full py-1.5 text-sm font-normal rounded-sm  bg-gradiant-to-t from-[#f7dfa5] to-[#f0c14b] hover:bg-gradient-to-b border
              border-zinc-400 active:border-yellow-800 active:shadow-amazonInput'>Continue</button>
                ...
                <p className='text-xs text-black leading-4 mt-4'>By Continuing, you agree to Amazon's
                  <span className='text-blue-600'>Conditions of Use{" "}</span>and<span className='text-blue-600'>
                    Privace Notivce.</span></p>
                <p className='text-xs text-gray-600 mt-4 cursor-pointer group'><ArrowRightIcon /><span className='text-blue-600
             group-hover:text-orange-700 group-hover:underline-offset-1'>Need help?</span></p>
              </div>
              ...
              <Link className='w-full' to="/registration">
                <button className='w-full py-1.5 mt-4 text-sm font-normal rounded-none bg-gradient-to-t
          font-slate-200 to-slate-100 hover:bg-gradient-to-b border border-zinc-
